...
using FileCompare.Infastructure.Configurations;
...
namespace FileCompare.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("Register")]
        public async Task<IActionResult> Register([Required] [FromBody] UserDetailDTO userDetails)
        {
        ...
        [HttpPost]
        [Route("Login")]
        public async Task<IActionResult> Login([Required] [FromBody] LoginCredentialDTO credentials)
        {
        ...
        private async Task<IdentityUser> ValidateUser(LoginCredentialDTO credentials)
        {
